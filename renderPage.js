module.exports = function renderHomePage() {
  return [
    ...
    '        </div>',
    '        <p style="margin-top: 0.75rem; color: var(--muted); font-size: 0.92rem;">Le bot doit être connecté et non enregistré pour générer le code de pairing.</p>',
    '      </div>',
    '      <div class="card">',
    '        <h2>✓ Résultat</h2>',
    ...
    '        statusBox.innerHTML = "<span class=\"badge\">Code</span> " + (data.code || "Aucun code reçu");',
    '      } catch (err) {',
    '        statusBox.innerHTML = "<span class=\"badge\">Erreur</span> " + (err.message || "Impossible de récupérer le code");',
