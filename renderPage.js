module.exports = function renderHomePage() {
  return [
    ...
    '        <div class="output" id="debugLog" style="margin-top: 1rem; font-size: 0.95rem; max-height: 5rem; overflow:auto; color: var(--muted); background: rgba(255,255,255,0.02); border-color: rgba(255,255,255,0.05);"></div>',
    '      </div>',
    '    </div>',
    '    <div class="footer">',
    ...
    '        const ready = data.connected && !data.registered;',
    ...
    '        if (!ready) {',
    '          statusBox.innerHTML += "<br><span class=\"badge\">Info</span> " + (data.registered ? "Réinitialisez la session si le bot est enregistré." : "Attente du bot...");',
    '        } else {',
